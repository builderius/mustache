...
class Engine
{
    ...
    public function loadPartial($name, $context)
    {
        try {
            ...
            $this->log(Logger::WARNING, 'Partial not found: "{name}"', array('name' => $e->getTemplateName()));
        }
    }
    /**
    ...
    private function compile($source)
    {
        ...
        $this->log(Logger::INFO, 'Compiling template to "{className}" class', array('className' => $name));
